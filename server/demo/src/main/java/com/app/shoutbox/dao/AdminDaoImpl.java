...
public class AdminDaoImpl implements AdminDao {
	...
	public int deleteShout(Boolean shoutsInactive,Integer id){
		logger.info("inside AdminDaoImpl.deleteShout()");
		return repo.deleteShout(shoutsInactive, id);
	}
